    ...
    D: DrawTarget<Color = Rgb888>,
{
    ...
    // Three buttons at bottom: Rest, Stats, Inventory
    // Rest button (left)
    Rectangle::new(Point::new(14, 370), Size::new(110, 50))
    ...
    // Stats button (middle)
    Rectangle::new(Point::new(130, 370), Size::new(110, 50))
    ...
    Rectangle::new(Point::new(246, 370), Size::new(110, 50))
