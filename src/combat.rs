...
pub fn apply_damage(context: &mut Context, modifier: f32) {
...
pub fn apply_hero_damage(context: &mut Context) {
...
pub fn calculate_hero_stats(context: &Context) -> (f32, f32) {
...
pub fn calculate_damage(attacker_level: i32, attacker_base_atk: i32, defender_level: i32, defender_base_def: i32) -> i32 {
...
pub fn create_enemy(enemies: &Vec<EnemyShort>) -> Result<Enemy> {
